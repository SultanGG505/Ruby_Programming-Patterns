...
student = Student.new("Иванов", "Иванов", "Иван", "Иванович", phone: "+7(123)-456-78-90", git: "@ivanov", telegram: "@ivanov", email: "ivanov@example.com")
puts student
student_short = StudentShort.new(12345, "Иванов И. И., git: @ivanov, contacts: phone: +7(123)-456-78-90, email: ivanov@example.com")
puts student_short