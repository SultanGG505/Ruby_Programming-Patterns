...
#                                                                                гарантируя, что данные остаются
# в согласованном состоянии. Геттеры и сеттеры — это методы,
...
#                                                                                                        в новый суперкласс.
# Затем исходный класс становится подклассом суперкласса и может при необходимости переопределять
...
#   Агрегация — это слабая форма ассоциации, когда один класс может иметь несколько экземпляров другого класса,#                                                                                                       но не владеет им. Например, класс «Отдел» может иметь несколько экземпляров класса «Сотрудник», но сотрудники
